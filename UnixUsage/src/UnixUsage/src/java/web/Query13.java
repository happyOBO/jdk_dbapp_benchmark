 ...
 * @author KTam
 */
public class Query13 extends HttpServlet {
    ...
    throws ServletException, IOException {
        try {
            ...
            if (request.getParameterMap().containsKey("selectedDept"))
            {
                ...
                float results = DeptInfoManager.computeFemaleToMaleRatio(selectedDept);
            ...
            RequestDispatcher view = request.getRequestDispatcher("13.jsp");
