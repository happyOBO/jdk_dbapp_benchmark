 ...
 * @author KTam
 */
public class Query15 extends HttpServlet {
    ...
    throws ServletException, IOException {
        try
        {
            ...
            if (request.getParameterMap().containsKey("selectedCourse"))
            {
                ...
                List<String> results = CourseInfoManager.getTopFiveCommands(selectedCourse, score);
            ...
            RequestDispatcher view = request.getRequestDispatcher("15.jsp");
