...
public class AddDeptInfo extends HttpServlet {
    ...
    throws ServletException, IOException {
        try {
            if (request.getParameterMap().containsKey("deptId"))
            {
                int deptId = Integer.parseInt(request.getParameter("deptId"));
                String deptName = request.getParameter("deptName");

                DeptInfoManager.addDepartment(deptId, deptName);
            ...
            RequestDispatcher view = request.getRequestDispatcher("addDeptInfo.jsp");
