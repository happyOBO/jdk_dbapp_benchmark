 ...
 * @author KTam
 */
public class Query18 extends HttpServlet {
    ...
    throws ServletException, IOException {
        try {
            ...
            if (request.getParameterMap().containsKey("selectedDept"))
            {
                ...
                float results = DeptInfoManager.computeFileToNetworkRatioForDept(selectedDept);
            ...
            RequestDispatcher view = request.getRequestDispatcher("18.jsp");
