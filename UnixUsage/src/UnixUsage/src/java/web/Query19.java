 ...
 * @author KTam
 */
public class Query19 extends HttpServlet {
    ...
    throws ServletException, IOException {
        try
        {
            final Dictionary<String, Float> results =
                    DeptInfoManager.computeFileToNetworkRatioForAllDepts();
            ...
            RequestDispatcher view = request.getRequestDispatcher("19.jsp");
