 ...
 * @author KTam
 */
public class Query20 extends HttpServlet {
    ...
    throws ServletException, IOException {
        try {
            final Dictionary<String, Float> results =
                    DeptInfoManager.computeCSToOtherDeptsPasswordLengthRatio();
            ...
            RequestDispatcher view = request.getRequestDispatcher("20.jsp");
