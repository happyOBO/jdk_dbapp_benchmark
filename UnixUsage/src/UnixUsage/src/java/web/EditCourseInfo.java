...
public class EditCourseInfo extends HttpServlet {
    ...
    throws ServletException, IOException {
        try {
            ...
            if (request.getParameterMap().containsKey("findCourseId"))
            {
                int courseId = Integer.parseInt(request.getParameter("findCourseId"));
                for (ICourseInfo courseInfo : CourseInfoManager.getAllCourses())
                {
                    if (courseInfo.getCourseId() == courseId)
            ...
            if (request.getParameterMap().containsKey("courseId"))
            {
                ...
                CourseInfoManager.editCourse(courseId,
            ...
            RequestDispatcher view = request.getRequestDispatcher("editCourseInfo.jsp");
