...
public class EditUserInfo extends HttpServlet {
    ...
    throws ServletException, IOException {
        try {
            ...
            if (request.getParameterMap().containsKey("findUserId"))
            {
                String userId = request.getParameter("findUserId");
                request.setAttribute("userInfo", UserInfoManager.getUserBy(userId));
            }
            ...
            if (request.getParameterMap().containsKey("userId"))
            {
                ...
                request.setAttribute("userInfo", 
                    UserInfoManager.editUserInfo(request.getParameter("userId"),
            ...
            RequestDispatcher view = request.getRequestDispatcher("editUserInfo.jsp");
